    ...
    data() {
      return {
        ...
        header: [
          ...
          { prop: 'makeConfirm', label: '制造商确认', eachWidth: 32, fixed: 'right', disabled: this.$store.getters.userLoginVO.role === 1, select: [{id: 0, label: 'Not OK'}, {id: 1, label: 'OK'}, {id: 2, label: 'OK with reserves'}, ]},
          { prop: 'tcConfirm', label: 'YFPO  TC 确认', eachWidth: 15, fixed: 'right', disabled: this.$store.getters.userLoginVO.role === 2, select: [{id: 0, label: 'Not OK'}, {id: 1, label: 'OK'}, {id: 2, label: 'OK with reserves'}, ]},
          { prop: 'factoryConfirm', label: 'YFPO  工厂确认', eachWidth: 16, fixed: 'right', disabled: this.$store.getters.userLoginVO.role === 2, select: [{id: 0, label: 'Not OK'}, {id: 1, label: 'OK'}, {id: 2, label: 'OK with reserves'}, ]},
        ],
