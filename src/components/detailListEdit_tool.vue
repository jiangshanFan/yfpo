              ...
              <el-col :span="12">
                <el-col :span="12">
                  <el-form-item label="A" label-width="30px" prop="a1Length">
                    <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.a1Length"></el-input>mm
                  </el-form-item>
                </el-col>

                <el-col :span="12">
                  <el-form-item label="a" label-width="30px" prop="alength">
                    <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.alength"></el-input>mm
                  </el-form-item>
                </el-col>

                <el-col :span="12">
                  <el-form-item label="B1" label-width="30px" prop="b1Length">
                    <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.b1Length"></el-input>mm
                  </el-form-item>
                </el-col>

                <el-col :span="12">
                  <el-form-item label="b" label-width="30px" prop="blength">
                    <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.blength"></el-input>mm
                  </el-form-item>
                </el-col>

                <el-col :span="12">
                  <el-form-item label="B2" label-width="30px" prop="b2Length">
                    <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.b2Length"></el-input>mm
                  </el-form-item>
                </el-col>

                <el-col :span="12">
                  <el-form-item label="c" label-width="30px" prop="clength">
                    <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.clength"></el-input>mm
                  </el-form-item>
                </el-col>
              </el-col>
            </el-row>
            ...
            <el-row class="flex_row_spaceAround mt40">
              <el-row>
                ...
                <el-form-item label="一级顶行程" prop="firstTopTrip">
                  <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.firstTopTrip"></el-input>mm
                </el-form-item>
              </el-row>

              <el-row>
                <el-form-item label="定模侧重量" prop="fixedWeight">
                  <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.fixedWeight"></el-input>kg
                </el-form-item>

                <el-form-item label="二级顶行程" prop="secondTopTrip">
                  <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.secondTopTrip"></el-input>mm
                </el-form-item>
              </el-row>

              <el-row>
                <el-form-item label="动模侧重量" prop="dynamicWeight">
                  <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.dynamicWeight"></el-input>kg
                </el-form-item>

                <el-form-item label="三级顶行程" prop="thirdTopTrip">
                  <el-input clearable style="width:calc(100% - 30px);margin-right: 5px;max-width:120px;" v-model="form.thirdTopTrip"></el-input>mm
                </el-form-item>
              </el-row>
            </el-row>

            <el-row class="tc mt40" :gutter="40">
...
/* eslint-disable */
  ...
  /** 导入api.js */
  import { getToolInformationByMouldNo, updateToolInformationByMouldNo, } from '../axios/api.js'
      ...
      submitForm(formName) {
        this.$refs[formName].validate(async (valid) => {
          if (valid) {
            ...
            if (res.status === 1) {
              Message({showClose: true, type: 'success', message: '更新TOOL INFORMATION成功！'})
            }
          } else {
      ...
      let validate1 = (rule, value, callback) => {
        if (!value) {
          ...
          if (!/^(\d|[1-9]\d{0,6})(\.\d{1,2})?$/.test(value)) {
            ...
            Message({showClose: true, type: 'error', message: '提示“小数点前1-7位，小数点后1-2位”！'})
          } else {
            callback();
          }
        }
      ...
      let validate2 = (rule, value, callback) => {
        if (!value) {
          ...
          if (!/^(\d|[1-9]\d{0,5})(\.\d)?$/.test(value)) {
            callback(new Error('输入有误，请核对'));
            Message({showClose: true, type: 'error', message: '提示“小数点前1-6位，小数点后1位”！'})
          } else {
            callback();
          }
        }
